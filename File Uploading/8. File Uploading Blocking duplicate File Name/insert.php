      ...
      try{
        ...
        if($_FILES['aphoto']['size'] == 0) {
          throw new Exception('Please Select a file '); 
            ...
            $valid_format = array("doc" , "jpeg","jpg","png");   
            ...
            $result = mysql_query("select * from animaldata  where aphoto = '$file_name'  ");
            ...
            if(strlen($file_name))
            {
                ...
                {	  
                  ...
                  { 		   
                    if($count<1) {
                      ...
                      $expire_date = ("2016/08/25 11:59:59 a ") ;
                ...
                throw new Exception('Invalid File format.File must be.........');        
                      }
            } 
            else {
              throw new Exception("Please select a file!!!");  
