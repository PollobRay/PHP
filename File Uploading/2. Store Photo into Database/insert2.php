<?php
	...
	if(isset($_POST['form1'])) // Getting all informatin in form1 and veryfy
	{
		try{
			...
			values('', '$aname', '$adetails', '$aphoto')" ); // If no error data will inter into database
...
<html>
	...
	<body> 
		...
		<form action ="" method="post"  enctype="multipart/form-data" >
			...
			<table border=0 align=left bgcocor=black width=100%>          
				<tr>
					<td colspan=2><h2> &nbsp</h2> </td>
				</tr>	  
			</table>

			<table border = 0 align=left bgcocor=gray>          
				<tr>
